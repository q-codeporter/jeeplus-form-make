<template>
  <div class="form-config-container">
    ...
    <code-dialog ref="styleDialog" mode="css" :title="$t('fm.config.form.styleSheets')" help="https://www.yuque.com/ln7ccx/ntgo8q/bau8eo" @on-confirm="handlestyleSheetsConfirm"></code-dialog>
  </div>
</template>
